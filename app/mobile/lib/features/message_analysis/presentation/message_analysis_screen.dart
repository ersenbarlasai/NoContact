...
class _MessageAnalysisScreenState extends ConsumerState<MessageAnalysisScreen> {
          ...
          child: Column(
            ...
            children: [
              ...
              const StillPrivacyNotice(
                text: 'Bu sürümde mesajın cihazından çıkmaz ve kaydedilmez.',
              ),
  ...
  Widget _buildResultState(MessageAnalysisState state) {
    ...
    return Column(
      ...
      children: [
              ...
              child: StillCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(result.toneLabel, style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                    const SizedBox(height: 8),
                    Text(
                      result.summary,
        ...
        if (result.manipulationSignals.isNotEmpty) ...[
          Text('Tespit Edilen Sinyaller', style: Theme.of(context).textTheme.labelSmall),
          const SizedBox(height: 8),
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: result.manipulationSignals.map((s) => Container(
        ...
        StillCard(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              Text(
                _getActionDescription(result.recommendedAction),
        ...
        if (result.suggestedReply != null) ...[
          ...
          StillCard(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Taslak Yanıt (Opsiyonel)', style: Theme.of(context).textTheme.labelSmall),
                const SizedBox(height: 12),
                Text(
  ...
  Color _getActionColor(RecommendedAction action) {
    switch (action) {
      ...
      case RecommendedAction.wait24Hours: return AppColors.primaryContainer;
  ...
  Color _getOnActionColor(RecommendedAction action) {
    switch (action) {
      ...
      case RecommendedAction.wait24Hours: return AppColors.onPrimaryContainer;
  ...
  String _getActionLabel(RecommendedAction action) {
    switch (action) {
      ...
      case RecommendedAction.wait24Hours: return '24 Saat Bekle';
      case RecommendedAction.replyWithBoundary: return 'Sınırla Yanıtla';
    }
  }

  String _getActionDescription(RecommendedAction action) {
    switch (action) {
      case RecommendedAction.doNotReply: return 'Sessizlik senin en güçlü sınırındır. Etkileşime girmeyerek enerjini geri kazanır ve geri bildirim döngüsünü kırarsın.';
      case RecommendedAction.wait24Hours: return 'Şu anki hislerin yoğun olabilir. 24 saat sonra bu mesaja bakmak daha sağlıklı bir perspektif sağlayacaktır.';
      case RecommendedAction.replyWithBoundary: return 'Sadece gerekli teknik/lojistik detaylara odaklan ve duygusal paylaşımlardan kaçın.';
    }
  }
}
