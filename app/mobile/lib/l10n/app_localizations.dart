...
abstract class AppLocalizations {
  ...
  /// No description provided for @messageAnalysisTitle.
  ///
  /// In tr, this message translates to:
  /// **'Mesaj Analizi'**
  String get messageAnalysisTitle;

  /// No description provided for @messageAnalysisInputTitle.
  ///
  /// In tr, this message translates to:
  /// **'Mesajı Yapıştır'**
  String get messageAnalysisInputTitle;

  /// No description provided for @messageAnalysisInputSubtitle.
  ///
  /// In tr, this message translates to:
  /// **'Ondan aldığın mesajı buraya yapıştır. Bu içerik cihazında işlenir.'**
  String get messageAnalysisInputSubtitle;

  /// No description provided for @messageAnalysisHint.
  ///
  /// In tr, this message translates to:
  /// **'Mesajı buraya yapıştır...'**
  String get messageAnalysisHint;

  /// No description provided for @messageAnalysisAnalyzeBtn.
  ///
  /// In tr, this message translates to:
  /// **'ANALİZ ET'**
  String get messageAnalysisAnalyzeBtn;

  /// No description provided for @messageAnalysisLoading.
  ///
  /// In tr, this message translates to:
  /// **'Analiz ediliyor...'**
  String get messageAnalysisLoading;

  /// No description provided for @messageAnalysisRisk.
  ///
  /// In tr, this message translates to:
  /// **'Risk Seviyesi'**
  String get messageAnalysisRisk;

  /// No description provided for @messageAnalysisPatterns.
  ///
  /// In tr, this message translates to:
  /// **'Tespit Edilen Paternler'**
  String get messageAnalysisPatterns;

  /// No description provided for @messageAnalysisSuggestedAction.
  ///
  /// In tr, this message translates to:
  /// **'Önerilen Eylem'**
  String get messageAnalysisSuggestedAction;

  /// No description provided for @messageAnalysisDetailTitle.
  ///
  /// In tr, this message translates to:
  /// **'Detaylı Analiz'**
  String get messageAnalysisDetailTitle;

  /// No description provided for @messageAnalysisSafeReply.
  ///
  /// In tr, this message translates to:
  /// **'Güvenli Yanıt Örneği'**
  String get messageAnalysisSafeReply;

  /// No description provided for @messageAnalysisGrounding.
  ///
  /// In tr, this message translates to:
  /// **'İçsel Onaylama'**
  String get messageAnalysisGrounding;

  /// No description provided for @messageAnalysisRiskHigh.
  ///
  /// In tr, this message translates to:
  /// **'Yüksek'**
  String get messageAnalysisRiskHigh;

  /// No description provided for @messageAnalysisRiskMedium.
  ///
  /// In tr, this message translates to:
  /// **'Orta'**
  String get messageAnalysisRiskMedium;

  /// No description provided for @messageAnalysisRiskLow.
  ///
  /// In tr, this message translates to:
  /// **'Düşük'**
  String get messageAnalysisRiskLow;

  /// No description provided for @messageAnalysisRiskHighDesc.
  ///
  /// In tr, this message translates to:
  /// **'Duygusal güvenliğin için yanıt vermemek en iyisidir.'**
  String get messageAnalysisRiskHighDesc;

  /// No description provided for @messageAnalysisRiskMediumDesc.
  ///
  /// In tr, this message translates to:
  /// **'İletişim döngüsünü yeniden açma riski taşır.'**
  String get messageAnalysisRiskMediumDesc;

  /// No description provided for @messageAnalysisRiskLowDesc.
  ///
  /// In tr, this message translates to:
  /// **'Bu mesaj düşük duygusal risk içeriyor gibi görünüyor.'**
  String get messageAnalysisRiskLowDesc;

  /// No description provided for @messageAnalysisActionDoNotReply.
  ///
  /// In tr, this message translates to:
  /// **'Cevap Verme'**
  String get messageAnalysisActionDoNotReply;

  /// No description provided for @messageAnalysisActionWait.
  ///
  /// In tr, this message translates to:
  /// **'Bekle'**
  String get messageAnalysisActionWait;

  /// No description provided for @messageAnalysisActionBoundary.
  ///
  /// In tr, this message translates to:
  /// **'Sınır Koy'**
  String get messageAnalysisActionBoundary;

  /// No description provided for @messageAnalysisActionSos.
  ///
  /// In tr, this message translates to:
  /// **'SOS Kullan'**
  String get messageAnalysisActionSos;

  /// No description provided for @messageAnalysisActionLetter.
  ///
  /// In tr, this message translates to:
  /// **'Mektup Yaz'**
  String get messageAnalysisActionLetter;
